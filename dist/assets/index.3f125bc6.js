...
!(function () {
  ...
  const Wo = (t, e, n) => {
    ...
    Xo = [
      ((t) => (We("data-v-020c5294"), (t = t()), qe(), t))(() =>
        Li("h1", { class: "air-conditioner-main-top-title" }, "便携小空调", -1)
      ),
    ];
  const Qo = Go(Jo, [
      [
  ...
  const gr = vr.exports,
          ...
          return (function (t, e) {
            ...
            Ri(
              "button",
              {
                class: c(
                  `anzhiyu-button ${
                    t.round ? "anzhiyu-button-round" : ""
                  } anzhiyu-button-${t.type}`
                ),
              },
    ...
    Zr = { class: "air-conditioner-tip" },
    Gr = [
      Kr(() => Li("div", { class: "air-conditioner-tip-icon" }, null, -1)),
      Kr(() =>
        Li(
          "div",
      ...
      Kr(() =>
        Li("div", { class: "air-conditioner-tip-highlight" }, "清凉！", -1)
      ),
    ];
  const Jr = Go(qr, [
      [
    ...
    ca = ((...t) => {
      ...
      Go(
        fn({
          __name: "App",
          setup: (t) => (t, e) => (
            Ei(), Ri("main", aa, [Vi(Qo), Vi(Jr), Vi($r), Vi(Wr), Vi(ra)])
          ),
        }),
